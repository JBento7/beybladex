  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Test tournaments */}
        <div className="mt-8 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 flex items-center justify-between gap-4">
          <div>
            <h2 className="text-base font-bold text-white">Torneios de Teste</h2>
            <p className="text-sm text-gray-400 mt-0.5">Crie e gerencie torneios de teste para validar configurações.</p>
          </div>
          <Link
            href="/test-tournaments"
            className="flex-shrink-0 bg-[#252525] hover:bg-[#333] text-gray-300 font-semibold px-4 py-2 rounded-lg text-sm transition-colors"
          >
            Abrir →
          </Link>
        </div>
